...
const UploadPlagrism = () => {
    ...
    const sendTextToAPI = async (text) => {
        ...
        try {
            ...
            const systemPrompt = "You are an AI-powered Plagarism detector. Your task is to receive text as input and detect plagarism in the content and give an output only in numbers that how much percentage is plagarised and how much percentage of the text is written by human. Do not give anything else as an output except these numbers, if unable to process then return all the values as 0. Return it in this sample format 'Plagarism - 0% and Human-content - 98%'";
            const sentence = text;
